 ...
 *
 * Para realizar este ejercicio se deben emplear objetos y clases. Una clase denominada "Agenda" y otra clase denomina "Contacto".
 *
 * Se puede seguir la estructura de la solución del ejercicio anteriormente expuesto.
 * 
 */
?>
